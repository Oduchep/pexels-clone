<template>
  <header>
    <nav class="px-6 py-3 flex items-center justify-between bg-[#232A34]">
      ...
      <button class="hidden md:block text-lg text-white">
        <i class="fa-solid fa-ellipsis"></i>
      </button>

      <button class="hidden md:block px-8 py-2 rounded font-semibold text-base text-white hover:text-gray-200 bg-btn-green"> Join </button>
